...
message = tk.Label(window, text="EXOVISION" ,bg="Red"  ,fg="white"  ,width=25 ,height=1,font=('Bradley Hand ITC', 50, 'italic bold ')) 

message.place(x=200, y=20)

lbl = tk.Label(window, text="✲ Enter ID ▷",width=20  ,height=3  ,fg="red"  ,bg="yellow" ,font=('times', 15, ' bold ') ) 
lbl.place(x=400, y=200)

txt = tk.Entry(window,width=20  ,bg="grey" ,fg="white",font=('times', 15, ' bold '))
txt.place(x=700, y=215)

lbl2 = tk.Label(window, text="✲ Enter Name ▷",width=20  ,fg="red"  ,bg="yellow"    ,height=2 ,font=('times', 15, ' bold ')) 
lbl2.place(x=400, y=300)

txt2 = tk.Entry(window,width=20  ,bg="grey"  ,fg="white",font=('times', 15, ' bold ')  )
